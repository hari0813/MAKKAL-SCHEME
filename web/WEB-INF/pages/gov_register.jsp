<html>
    ...
    <body>
        ...
        <form name="gov_register" method="post" action="gov_register_data.html">

            <div class="form_main">
                <div class="form_heading">
                    <p>GOVERNMENT REGISTER</p>
                </div>
                <br>
                <div class="form_section">
                    ...
                    <div class="row">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="gov_user_name" required="required"
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" name="gov_password"
                                   required="required"
                                   oninput="this.setCustomValidity('')"
                    ...
                    <div class="row">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="subdivition"

                                   required="required"
                                   oninput="this.setCustomValidity('')"
                                   oninvalid="this.setCustomValidity('Please Enter Subdivision')"
                                   />
                        </div>
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="PanchayatId"

                                   required="required"
                                   oninput="this.setCustomValidity('')"
                                   oninvalid="this.setCustomValidity('Please Enter PanchayatId')"
                                   />
                        </div>
