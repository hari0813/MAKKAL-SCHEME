        ...
        <div class="table-horizontal-container card" style="margin-top:2%;height:700px;padding-top:2%;padding-bottom:2%;">
            ...
            <div class="table-horizontal-container" style="overflow: scroll;margin:20px;">
                <table class="unfixed-table table-bordered table-striped" cellpadding="10px" rules="rows" align="center">
                    <thead class="tblhe">
                        <tr>
                            <td style="background-color: purple;color:white">Notification ID</td>
                            ...
                            <td style="background-color: purple;color:white">Delete</td>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <%
                            ...
                            List data = DBContext.getContext().readData("from Scheme where doctor_id='" + doctor_id + "'");
                            Iterator ite = data.iterator();
                              while (ite.hasNext()) {
                                  Scheme n = (Scheme) ite.next();%>

                        <tr>
                            <td><%=n.getNotification_id()%></td>
                            ...
                            <td><a href="delete_notice.html?nid=<%=n.getNotification_id()%>"><img src="images/images.png" height="20px" width="20px"/></a></td>
                        </tr>
                        <%  }
                        %>
